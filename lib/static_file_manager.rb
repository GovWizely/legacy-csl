...
class StaticFileManager
  CREDENTIALS = Aws::Credentials.new(Rails.configuration.csl.aws.access_key_id, Rails.configuration.csl.aws.secret_access_key)
  ...
  def self.get_s3_client
    Aws::S3::Client.new(region: Rails.configuration.csl.aws.region, credentials: CREDENTIALS)
  end
end
